...
def update_index(latest_briefing_path: Path, date_str: str):
    ...
    # Read latest briefing content (just the main section)
    ...
    main_content = content[main_start:main_end] if main_start != -1 else ''
...
<head>
    ...
    <title>AI-Pulse - Daily AI Sector Intelligence</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <h1>🧠 AI-Pulse</h1>
        <p class="tagline">Autonomous AI sector intelligence for investors</p>
        <nav>
            <a href="index.html" class="active">Latest</a>
    ...
    <div class="hero">
        <h2>Latest Briefing: {date_str}</h2>
        <p>AI-powered analysis of AI sector news, powered by Claude</p>
        <a href="briefings/{date_str}.html" class="cta-button">View Full Briefing →</a>
    </div>
    ...
    <footer>
        ...
        <p><a href="archive.html">View all past briefings →</a></p>
    </footer>
</body>
</html>
"""
